...
//TODO: ввести названия для полей _id, tsUpdate, которые не должны отличаться между схемами view
//TODO: сделать функцию init, реализующую синглтон
//TODO: описать, что insert возвращает только _id, tsUpdate
// конструктор
...
View.prototype.start = function( cb ) {
	this._provider.start( cb );
};
