...
var View = function( options ) {
	...
	this._defaultService = options.defaultService || this._defaultService;
	this._services = options.services || this._services;
	this._views = options.views || this._views;
	this._vids = options.vids || this._vids;
...
var methods = ['find', 'insert', 'modify', 'delete', 'getTemplate', '_loadTemplate', '_compileVidsRoots'];
var req;
