...
* ```request``` - объект, запрос пользователя
    ...
    * ```[options]``` - объект,
        ...
        * ```[sort]``` - массив массивов, правило сортировки Mongo
            * ```*``` - массив, элемент правила сортировки, содержит 2 элемента: ```vid``` и направление сортировки в следующем виде:[ vid, ( 1 | -1 ) ]
